...
namespace Week5UAMS
{
    class Program
    {
        ...
        static void viewRegisterStudents()
        {
            Console.WriteLine("Name \t FSC \t Ecat \t Age");
            foreach (Student s in studentList)
            {
        ...
        static void addOIntoDegreeList(DegreeProgram d)
        {
            programList.Add(d);
        }
        ...
        static Student takeInputForStudent()
        {
            ...
            Student s = new Student(name,age,fscMarks,ecatMarks,merit,preferences);
            return s;
        }
